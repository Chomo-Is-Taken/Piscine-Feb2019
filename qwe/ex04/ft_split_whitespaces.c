...
/*   Updated: 2019/02/27 18:59:16 by jopaning         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_fill(int i, char *rekt, char *str)
{
...
char	**ft_split_whitespaces(char *str)
{
	...
	{
		i = 0;
		if ((outplayed = malloc(sizeof(char*) * (number_of_words + 1)))
				== NULL)
			return (NULL);
		if ((rekt = malloc(sizeof(*rekt) * (ft_fake_strlen(str) + 1)))
				== NULL)
			return (NULL);
		ft_fill(i, rekt, str);
